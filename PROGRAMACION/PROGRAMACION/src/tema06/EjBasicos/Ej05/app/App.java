package tema06.EjBasicos.Ej05.app;
...
import tema06.EjBasicos.Ej05.modelo.Persona;
import tema06.EjBasicos.Ej05.servicios.PersonasService;
	...
	public static void main(String[] args) {
		...
		try {
			while (true) {
				...
				if (num == 5) {
					sc.nextLine();
					System.out.println("¿Qué DNI quieres borrar?");
					String dni = sc.nextLine();
